...
int big_evt; int sm_evt; int ievt;
double big_anode; double big_dynode; double big_npe; 
double sm_anode; double sm_dynode; double sm_npe;
double big_pmtx; double big_pmty; 
double sm_pmtx; double sm_pmty;
Long64_t big_second; double big_ns; 
Long64_t sm_second; double sm_ns;
double dftime; 
int sm_nhit=0;
...
cout<<"ibig="<<jentry<<",bigsec="<<bigsecond<<",bigns="<<bigns<<",smsize="<<smsecond.size()<<endl;
...
big_evt=jentry; sm_evt=smievt[i];
big_second=bigsecond;  big_ns=bigns; 
sm_second=smsecond[i]+1; sm_ns=smns[i];

big_anode=anode_charge; big_dynode=dynode_charge;
...
cout<<",df0="<<second-bigsecond_evt0<<",df1="<<second-bigsecond_evtend<<endl;
...
std::cout<<"nentries="<<nentries<<",length="<<smsecond.size()<<",smevt0="<<smevt0<<std::endl;
